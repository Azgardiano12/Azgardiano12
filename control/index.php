...
<body>
        ...
        <ul class="main-nav p-0 mt-2">
          <?php
            ...
            while ($MODULO_PADRE = $MODULOS->fetch_object())  { 
              ?>        
          <li><a data-bs-toggle="collapse" href="#<?=$MODULO_PADRE->nombre?>" aria-expanded="false">
          <i class="ph-duotone  ph-house-line"></i><?=$MODULO_PADRE->nombre?></a> 
  ...
  <script src="../assets/panel.js?<?=time()?>"></script>
</body>
