...
CREATE TABLE `modulos` (
  ...
  `nombre` varchar(50) NOT NULL,
  `icon` longblob NOT NULL COMMENT 'imagen',
...
/* Function  structure for function  `crud_materia_pr_R` */

/*!50003 DROP FUNCTION IF EXISTS `crud_materia_pr_R` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `crud_materia_pr_R`(num INT,
    clave INT,              
    Nombre varchar(100),
    cantidad INT,
    Tipo INT,
